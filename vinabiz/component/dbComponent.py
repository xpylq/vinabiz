...
def add_company(data):
    ...
    sql = "INSERT INTO vinabiz_company(guid,name,url,a1,a2,a3,a4,a5,a6,a7," \
          ...
          (
              data['guid'], data['name'], data['url'], data['a1'], data['a2'], data['a3'], data['a4'], data['a5'],
              data['a6'], data['a7'], data['b1'],
              data['b2'],
              data['b3'], data['b4'], data['b5'], data['b6'], data['b7'], data['b8'],
              data['b9'], data['b10'], data['b11'], data['b12'], data['b13'], data['b14'], data['c1'], data['c2'],
              data['c3'], data['c4'], data['c5'],
              data['c6'])
    try:
        cursor.execute(sql)
        db.commit()
